...
int graphics_test()
{
	...
	colmng.push_back(blk_fixed, [](collisionable_sprite* s) { s->set_run_on_collision([](collisionable_base* b) {cout << console::color::DARK_GRAY << "Block \"fixed\" collided once! lmao"; b->revert_once(); }); });
